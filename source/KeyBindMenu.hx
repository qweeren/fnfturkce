...
class KeyBindMenu extends FlxSubState
{
	...
	var keyText:Array<String> = ["SOL", "SAG", "YUKARI", "ASAGI"];
	...
	var tempKey:String = "";
	var blacklist:Array<String> = ["ESC", "ENTER", "BACKSPACE", "SPACE"];

	var blackBox:FlxSprite;
	var infoText:FlxText;

	var state:String = "seç";
	...
	override function create()
	{
		...
		infoText = new FlxText(-10, 580, 1280, "(ESC ile kaydet, BACKSPACE ile kaydetmeden çik.)", 72);
	...
	function textUpdate()
	{
		...
		for (i in 0...4)
		{
			...
			keyTextDisplay.text += textStart + keyText[i] + ": " + ((keys[i] != keyText[i]) ? (keys[i] + " / ") : "") + keyText[i] + " OK\n";
		}
